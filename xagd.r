...
tmp=dbGetQuery(con,'select * from xagd where Date>"2011-04-01" and Date<"2012-03-01 order by Date"')
dbDisconnect(con)
...
chartSeries(XAGD,TA=c(addVo(),addEMA(n=13,col="red"),addSAR(),addMYADX(m=14),addMACD(),addSCO()))
