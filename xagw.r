...
tmp=dbGetQuery(con,'select * from xagw where Date>"2007-01-01" and Date<"2012-03-01 order by Date"')
dbDisconnect(con)
XAGW=xts(tmp[,-1],as.Date(tmp[,1],"%Y-%m-%d"))
...
#layout.show(2)
chartSeries(XAGW,TA=c(addVo(),addEMA(n=13,col="red"),addSAR(),addMYADX(m=14),addMACD(),addFI(m=2),addBU(m=13),addBE(m=13)))
