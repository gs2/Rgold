...
tmp=dbGetQuery(con,'select * from xaud where Date>"2011-09-01" and Date<"2012-03-01 order by Date"')
dbDisconnect(con)
XAUD=xts(tmp[,-1],as.Date(tmp[,1],"%Y-%m-%d"))
...
chartSeries(XAUD,TA=c(addVo(),addEMA(n=13,col="red"),addSAR(),addMYADX(m=14),addMACD(),addSCO(),addWMR(m=14)))
