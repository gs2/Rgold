...
tmp=dbGetQuery(con,'select * from xauw where Date>"2007-04-01" and Date<"2012-03-01 order by Date"')
dbDisconnect(con)
...
#layout.show(2)
chartSeries(XAUW,TA=c(addVo(),addEMA(n=13,col="red"),addSAR(),addMYADX(m=14),addMACD(),addFI(m=2),addBU(m=13),addBE(m=13)))
